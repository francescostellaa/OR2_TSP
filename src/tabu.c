...
int tabu(const instance* inst, tour* solution, double timelimit, int interval_tenure, float tenure_scaling) {
    ...
    while (true) {
        ...
        save_history_incumbent(current_best_cost, "../data/incumbent_tabu.txt");
        save_history_cost(solution->cost, "../data/cost_tabu.txt");
    }

    plot_solution(inst, solution->path);
    plot_incumbent("../data/incumbent_tabu.txt", "../data/incumbent_tabu.png");
    plot_history_cost("../data/cost_tabu.txt", "../data/cost_tabu.png");
    plot_incumbent_and_costs("../data/cost_tabu.txt", "../data/incumbent_tabu.txt", "../data/incumbent_and_costs_tabu.png");
    free(when_tabu);
